...
constexpr string_view(iterator first, iterator last) : _str(first.container()), _begin(first), _end(last){}
constexpr string_view::string_view(const utf8::string& str) : string_view(&str, str.cbegin(), str.cend()){}
...
constexpr string_view::size_type string_view::size() const {return std::distance(this->cbegin(), this->cend());}
constexpr string_view::size_type string_view::length() const {return std::distance(this->cbegin(), this->cend());}
...
constexpr const_string_view::const_string_view(const const_string_view::string_view& other) = default;
constexpr const_string_view::const_string_view& operator=(const const_string_view::string_view& other) = default;
constexpr const_string_view::const_string_view(const const_string_view::const_string_view& other) = default;
constexpr const_string_view::const_string_view& operator=(const const_string_view::const_string_view& other) = default;

constexpr const_string_view::iterator const_string_view::begin() {return _begin;}
...
constexpr const_string_view::iterator const_string_view::end() {return _end;}
...
constexpr const_string_view::size_type const_string_view::size() const {return std::distance(this->begin(), this->end());}
constexpr const_string_view::size_type const_string_view::length() const {return std::distance(this->begin(), this->end());}

constexpr bool const_string_view::empty() const {return this->begin() == this->end();}

constexpr void const_string_view::swap(string_view& other){
	std::swap(this->_str, other.str);
	std::swap(this->_begin, other._begin);
	std::swap(this->_end, other._end);
}
