...
//private:
	...
	*/
	...
	static void change_directory(void* ptr, const std::vector<utf8::const_string_view>& commands);
	static void print_working_directory(void* ptr, const std::vector<utf8::const_string_view>& commands);
